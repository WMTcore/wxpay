...
Wxpay.prototype.wxpay_pay = function(data, res) {
    ...
    return wxpayNotify.getHttpResponsePOST(this.wxpay_config.wxpay_pay_url, postData, infoList);
}
...
Wxpay.prototype.wxpay_refund = function(data, res) {
    ...
    let postData = wxpaySubmit.buildRequestPara(parameter);
    //post
    return wxpayNotify.getHttpsResponsePOST(this.wxpay_config.wxpay_refund_url, postData, infoList);
};
...
Wxpay.prototype.wxpay_notify = function(req, res) {
    ...
    let infoList = ['attach', 'time_end', 'rate', 'transaction_id', 'device_info', 'out_trade_no', 'openid'];
